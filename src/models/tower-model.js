...
export const setTower = (userId, positionX, positionY, type, timestamp, data, isGetBuff, buffTowerPos, buffTarget) => {
...
export const upgradeTower = (userId, towerId, positionX, positionY) => {
  ...
  if (index !== -1) {
    ...
    towers[userId][index].data.attack_speed = towers[userId][index].data.attack_speed + 1;
